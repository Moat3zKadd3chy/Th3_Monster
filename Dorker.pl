...
#GS-Dorker | Coded By Fallag Gassrini | Tunisian Fallaga Team | xD Thanks Gass , Kadd3chy Was Here , Thank you very much Gass ♥
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color("bold white"),"Gimme Dork:";
$dork=<STDIN>;
chomp($dork);
$dork=~s/ /+/g;
gassonee();
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color("bold white")," Enter List Website:";
my $list=<STDIN>;
chomp($list);
        open (THETARGET, "<$list") || die "[-] Enter List Lool ?!";
@TARGETS = <THETARGET>;
close THETARGET;
$link=$#TARGETS + 1;
